// Test version of BlogDetail that uses dummy data
import BlogRepositoryTest from './blogRepositoryTest.js';
import Gallery from '../ui/components/Gallery.js';
import Tag from '../ui/components/Tag.js';

class BlogDetailTest {
    ...
    async init() {
        try {
            ...
            // Fetch blog from test repository
            const blog = await BlogRepositoryTest.getBlogById(blogId);
