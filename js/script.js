...
(function() {
    ...
    function sendMessage(form, select, output) {
        ...
        var dateOfEnquery = new Date().toLocaleString();
        var adultTravelers = formData.get('travelers1');
        var childrenTravelers = formData.get('travelers2');
        var hearAbout = formData.get('hearabout');
        ...
        enqueryRef.push({
            ...
            minorTraverls: childrenTravelers,
            hearAboutUsFrom: hearAbout,
            dateTime: dateOfEnquery,
            message: message
        }, function(error) {
            form
                .addClass('success')
